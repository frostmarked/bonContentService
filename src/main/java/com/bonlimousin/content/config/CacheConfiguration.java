package com.bonlimousin.content.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bonContentService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bonContentService");
        ...
        config.getMapConfigs().put("com.bonlimousin.content.domain.*", initializeDomainMapConfig(jHipsterProperties));
