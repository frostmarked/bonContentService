...
@RestController
@RequestMapping("/api/bon-content-service-kafka")
public class BonContentServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BonContentServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BonContentServiceKafkaResource(KafkaProperties kafkaProperties) {
